...
HD_PWD='C:/Zynq_Book/Zedboard_Mandel/Zedboard_Mandel.runs/engine_pll_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log engine_pll.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source engine_pll.tcl

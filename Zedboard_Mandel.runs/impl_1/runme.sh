...
HD_PWD='C:/Zynq_Book/Zedboard_Mandel/Zedboard_Mandel.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Mandel.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Mandel.tcl -notrace

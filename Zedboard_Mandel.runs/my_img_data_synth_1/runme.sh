...
HD_PWD='C:/Zynq_Book/Zedboard_Mandel/Zedboard_Mandel.runs/my_img_data_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log my_img_data.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source my_img_data.tcl

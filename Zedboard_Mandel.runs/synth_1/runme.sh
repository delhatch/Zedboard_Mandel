...
HD_PWD='C:/Zynq_Book/Zedboard_Mandel/Zedboard_Mandel.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mandel.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mandel.tcl

...
#
# Generated by export_simulation on Thu Jan 11 18:23:48 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './my_img_data.sh' script.

./my_img_data.sh -reset_run
...
./my_img_data.sh -noclean_files

For more information on the script, please type './my_img_data.sh -help'.

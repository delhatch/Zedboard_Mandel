...
#
# Generated by export_simulation on Thu Jan 11 18:17:05 -0800 2018
#
################################################################################
...
'-reset_run' switch to the './engine_pll.sh' script.

./engine_pll.sh -reset_run
...
./engine_pll.sh -noclean_files

For more information on the script, please type './engine_pll.sh -help'.
